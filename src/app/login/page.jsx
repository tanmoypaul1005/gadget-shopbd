                ...
                <div className="container">
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-full px-4">
                            <div
                                className="max-w-[525px] mx-auto text-center bg-white rounded-lg
                                relative overflow-hidden py-14 px-8 sm:px-12 md:px-[60px] wow fadeInUp"data-wow-delay=".15s">
                                ...
                                <form>
                                    <div className="mb-6">
                                        <input
                                            ...
                                            placeholder="Email"
                                            className="
                                            w-full rounded-md border border-[#E9EDF4]
                                            py-3 px-5 bg-[#FCFDFE]
                                    ...
                                    <div className="">
                                        <input
                                            ...
                                            className="w-full rounded-md border border-[#E9EDF4]
                                            py-3 px-5
                                ...
                                <ul className="flex justify-between -mx-2 mb-6">
                                    <li className="px-2 w-full">
                                        <div
                                            ...
                                            bg-[#4064AC] hover:bg-opacity-90 transition">
                                            <svg
                                                width="10"
                                                height="20"
                                                viewBox="0 0 10 20"
                                    ...
                                    <li className="px-2 w-full">
                                        <a
                                            ...
                                            rounded-md bg-[#D64937] hover:bg-opacity-90 transition
                                            "
                                        >
                                            <svg
                                                width="18"
