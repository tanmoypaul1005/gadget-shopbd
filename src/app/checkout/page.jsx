...
function Checkout() {
    return (
        <div>
            <div className="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-[10px] lg:px-[20px] xl:px-[20px]">
                ...
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <div className="">
                        ...
                        <div className="relative">
                            ...
                            shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
